...
Queue.NoobPve = {
  ...
  max_players = 8,
  max_player_lvl = 10,
  map_rotation = "arizona_silo:ConquerCoopVsAi;bridge:AssaultCoopVsAi;powerplant:AssaultCoopVsAi;rockcity:ConquerCoopVsAi;rockcity_2bases:AssaultCoopVsAi;riverport:AssaultCoopVsAi;iron_way_center:AssaultCoopVsAi;sand_valley:AssaultCoopVsAi",
...
Queue.NoobPvp = {
  ...
  min_player_lvl = 1,
  max_player_lvl = 11,
  map_rotation = "arizona_silo:ConquerQuick;castle:ConquerQuick;factory:AssaultQuick;bridge:AssaultQuick;powerplant:AssaultQuick;rockcity:ConquerQuick;rockcity_2bases:AssaultQuick;riverport:AssaultQuick;cityruin:ConquerQuick;iron_way_center:AssaultQuick;sand_valley:AssaultQuick",
...
Queue.NoobPvp2 = {
  ...
  min_player_lvl = 12,
  max_player_lvl = 16,
  map_rotation = "arizona_silo:Conquer;castle:Conquer;factory:Assault;bridge:Assault;powerplant:Assault;rockcity:Conquer;rockcity_2bases:Assault;riverport:Assault;cityruin:Conquer;iron_way_center:Assault;sand_valley:Assault",
  bot_design = "DesignPreset_BotEasy",
  ai_difficulty = 0,
  bot_rating_delta = 1000,
  priority = 2,
...
Queue.Brawl_Tanks = {
  max_players = 8,
  min_players = 8,
  map_rotation = "cityruin:Brawl_Tanks",
...
Queue.Brawl_Scorpion = {
  ...
  min_players = 8,
  max_record_size = 1,
  map_rotation = "factory:Brawl_Scorpion;castle:Brawl_Scorpion",
  joinin_forbidden = true,
  stat_category = "BRAWL",
  mm_initial_radius = 10000
}
